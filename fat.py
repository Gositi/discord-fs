    ...
    def updateFile (self, path, messages = None, file = None):
        if messages:
            if path [1:] in self.getDir ("/"):
                ...
                self.fat ["fat"]["files"][path [1:]] = {"messages": messages, "metadata": {'st_atime': 0.0, 'st_ctime': 0.0, 'st_gid': 1000, 'st_mode': 33204, 'st_mtime': 0.0, 'st_nlink': 1, 'st_size': 0, 'st_uid': 1000}}
        elif file:
